...
- [uci-news.py](deep-learning/uci-news.py) Multi-Class Classification with CNN on the UCI News dataset.
- [addition_rnn.py](deep-learning/addition_rnn.py) Implements Seq2Seq Learning for Performing Addition.
    - [addition_seq2seq.py](deep-learning/addition_seq2seq.py) Implemennts Seq2Seq with Attention for Addition Task.
...
- [elmo.py](deep-learning/elmo.py) Sentimental Analysis with ELMo Embeddings.
