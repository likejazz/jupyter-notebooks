...
- [model-evaluation.ipynb](https://nbviewer.jupyter.org/github/likejazz/jupyter-notebooks/blob/master/machine-learning/model-evaluation.ipynb)
...
- [tensorflow-weight.py](deep-learning/tensorflow-weight.py) TensorFlow's Weights 검증
...
- [cnn-classification.py](tensorboard/cnn-classification.py) Text Classification with CNN/TensorBoard
- [bert.py](deep-learning/bert.py) Example codes for BERT article
...
- [ghost-leg-probabilities.ipynb](https://nbviewer.jupyter.org/github/likejazz/jupyter-notebooks/blob/master/data-science/ghost-leg-probabilities.ipynb) 사다리 게임 확률 분석
